...
Public Class cryOrderRepo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportingApplication.cryOrderRepo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryOrderRepo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryOrderRepo = New cryOrderRepo()
        rpt.Site = Me.Site
        Return rpt
    End Function
